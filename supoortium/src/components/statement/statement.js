    ...
    <div className="h-screen flex flex-col">
      <div className="flex-1 p-4 overflow-y-auto mt-12 ml-64">
        {loaded && is_req ? (
          ...
          <div>
            {is_req ? (
              <b>Загружаются данные из сервера</b>
            ) : (
              <div className="text-center">
                ...
                <div className="from">
                  <select
                    ...
                    className="w-6/12 p-2 rounded-lg border bg-indigo-200"
                  >
                    {cat?.map((val, i) => {
                ...
                <textarea
                  ...
                  className="border w-6/12 bg-indigo-200 p-2 rounded-lg"
                  id=""
                  cols="34"
                  rows="10"
                  placeholder="text"
                ...
                <button
                  ...
                  className="bg-indigo-600 w-6/12 text-white w-80 p-2 rounded-lg ease-in hover:bg-indigo-500 font-extrabold text-gray-900 "
                >
                  {" "}
                  Отправить
                </button>
        ...
        {chatData && (
          <ChatClient
            websocketUrl={props.wecoket_url}
            roomName={chatData.roomName}
            currentUserEmail={chatData.recipientEmail}
          />
        )}
      </div>
    </div>
